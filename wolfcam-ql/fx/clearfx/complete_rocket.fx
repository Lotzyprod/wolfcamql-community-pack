...
//fx_rocket_flash                          "1"  - [eng] FLASH WHEN FIRED [ru] ВСПЫШКА ОТ ВЫСТРЕЛА
//fx_rocket_impact_stones                  "1"  - [eng] STONES FROM EXPLOSION [ru] КАМНИ ОТ ВЗРЫВА
//fx_rocket_impact_stones_value           "500" - [eng] VALUE OF STONES [ru] КОЛ-ВО КАМНЕЙ
//fx_rocket_impact_r                      "1.0" - [eng] RELATION OF RED COLOR IN EXPLOSION [ru] СООТНОШЕНИЕ КРАСНОГО ЦВЕТА ВО ВЗРЫВЕ
//fx_rocket_impact_g                      "0.2" - [eng] RELATION OF GREEN IN AN EXPLOSION [ru] СООТНОШЕНИЕ ЗЕЛЕНОГО ЦВЕТА ВО ВЗРЫВЕ
//fx_rocket_impact_b                       "0"  - [eng] RELATION OF BLUE COLOR IN EXPLOSION [ru] СООТНОШЕНИЕ СИНЕГО ЦВЕТА ВО ВЗРЫВЕ
//fx_rocket_vibrate                        "5"  - [eng] EXPLOSIVE VIBRATION [ru] ВИБРАЦИЯ ЭКРАНА ОТ ВЗРЫВА
//fx_rocket_impact_size                   "25"  - [eng] EXPLOSION SIZE [ru] РАЗМЕР ВЗРЫВА
//fx_rocket_impact_style                   "1"  - [eng] EXPLOSION STYLE [ru] СТИЛЬ ВЗРЫВА
//fx_rocket_impact_particles1              "1"  - [eng] PARTICLES 1 [ru] ЧАСТИЦЫ 1
//fx_rocket_impact_particles1_value       "2.0" - [eng] PARTICLES 1 VALUE[ru] КОЛ-ВО ЧАСТИЦ ПЕРВОГО ТИПА
//fx_rocket_impact_particles2              "1"  - [eng] PARTICLES 2 [ru] ЧАСТИЦЫ 2
//fx_rocket_impact_particles2_value       "500" - [eng] PARTICLES 2 VALUE [ru] КОЛ-ВО ЧАСТИЦ ВТОРОГО ТИПА
//fx_rocket_impact_particles3              "0"  - [eng] PARTICLES 3 [ru] ЧАСТИЦЫ 3
//fx_rocket_impact_particles3_value       "2.0" - [eng] PARTICLES 3 VALUE [ru] КОЛ-ВО ЧАСТИЦ ТРЕТЬЕГО ТИПА

//fx_rocket_projectile_size                "10" - [eng] ROCKET SIZE [ru] РАЗМЕР СНАРЯДА РАКЕТЫ
//fx_rocket_projectile_type                "1"  - [eng] TYPE OF ROCKET [ru] ТИП СНАРЯДА
//fx_rocket_projectile_smoke1              "1"  - [eng] SMOKE 1 [ru] ДЫМ 1
//fx_rocket_projectile_smoke1_size         "3"  - [eng] FIRST TYPE OF SMOKE SIZE [ru] РАЗМЕР ДЫМА ПЕРВОГО ТИПА
//fx_rocket_projectile_smoke1_length      "0.05"- [eng] FIRST TYPE OF SMOKE LENGTH [ru] ДЛИНА ДЫМА ПЕРВОГО ТИПА
//fx_rocket_projectile_smoke2              "1"  - [eng] SMOKE 2 [ru] ДЫМ 2
//fx_rocket_projectile_smoke2_size         "8"  - [eng] SIZE OF SMOKE OF SECOND TYPE [ru] РАЗМЕР ДЫМА ВТОРОГО ТИПА
//fx_rocket_projectile_smoke2_length      "0.2" - [eng] LENGTH OF SMOKE OF THE SECOND TYPE [ru] ДЛИНА ДЫМА ВТОРОГО ТИПА
//fx_rocket_projectile_smoke2_alpha       "0.3" - [eng] TRANSPARENCY SMOKE OF THE SECOND TYPE [ru] ПРОЗРАЧНОСТЬ ДЫМА ВТОРОГО ТИПА
//fx_rocket_projectile_smoke2_whiteratio  "0.1" - [eng] RELATIONSHIP WHITE TO BLACK COLOR OF SMOKE [ru] СООТНОШЕНИЕ БЕЛОГО К ЧЕРНОМУ ЦВЕТУ ДЫМА

//fx_rocket_trail                          "1"  - [eng] TRAIL FROM ROCKET [ru] СЛЕД ОТ СНАРЯДА РАКЕТЫ
//fx_rocket_trail_gradient                 "1"  - [eng] FLAME GRADIENT TYPE [ru] ТИП ГРАДИЕНТА ПЛАМЕНИ
//fx_rocket_trail_type                     "1"  - [eng] FLAME TYPE [ru] ТИП ПЛАМЕНИ
//fx_rocket_trail_particles                "1"  - [eng] PARTICLES [ru] ЧАСТИЦЫ
//fx_rocket_trail_b                        "1"  - [eng] RELATION OF BLUE COLOR IN FLAME [ru] СООТНОШЕНИЕ СИНЕГО ЦВЕТА В ПЛАМЕНИ
//fx_rocket_trail_r                        "0"  - [eng] RELATION OF RED COLOR IN THE FLAME [ru] СООТНОШЕНИЕ КРАСНОГО ЦВЕТА В ПЛАМЕНИ
//fx_rocket_trail_g                       "0.4" - [eng] CORRELATION OF GREEN IN FLAME [ru] СООТНОШЕНИЕ ЗЕЛЕНОГО ЦВЕТА В ПЛАМЕНИ
//fx_rocket_trail_length                   "10" - [eng] FLAME LENGTH [ru] ДЛИНА ПЛАМЕНИ
//fx_rocket_trail_size                     "10" - [eng] LENGTH OF EACH PARTICLE FLAME [ru] ДЛИНА КАЖДОЙ ЧАСТИЧКИ ПЛАМЕНИ
//fx_rocket_trail_width                   "8.0" - [eng] WIDTH OF EACH PARTICLE FLAME [ru] ШИРИНА КАЖДОЙ ЧАСТИЧКИ ПЛАМЕНИ
//...
//...
...
if (fx_rocket_impact_particles2 == 1) {
		movegravity 400
		shader prt_circle_blur
		repeat fx_rocket_impact_particles2_value/1.5 "2" +rand*fx_rocket_impact_particles2_value/3 {
			random v0
			v02            v02+rand*2
...
if (fx_rocket_projectile_type == 10) {
	...
	if (fx_rocket_projectile_smoke2 = 1) {	
		...
		emitter (fx_rocket_projectile_smoke2_length)*rand {
			...
			rotate t0 
			size (fx_rocket_projectile_smoke2_size*3/4) + lerp * t2
			alphaFade 0.5
	...
	if (fx_rocket_projectile_smoke1 = 1) {	
		...
		emitter (fx_rocket_projectile_smoke1_length)*rand {
			...
			rotate t0 
			size (fx_rocket_projectile_size/18) + lerp * t2 / 2
