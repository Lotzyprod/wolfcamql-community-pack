...
//fx_shotgun_r          "0.8" - [eng] RED COLOR RATIO [ru] СООТНОШЕНИЕ КРАСНОГО ЦВЕТА
//fx_shotgun_g          "0.4" - [eng] GREEN COLOR RATIO [ru] СООТНОШЕНИЕ ЗЕЛЕНОГО ЦВЕТА
//fx_shotgun_b          "0.0" - [eng] BLUE COLOR RATIO [ru] СООТНОШЕНИЕ СИНЕГО ЦВЕТА
//fx_shotgun_tracer      "1"  - [eng] ENABLE BULLET TRAIL? [ru] СЛЕД ОТ ВЫСТРЕЛА ДРОБОВИКА
//fx_shotgun_flash       "1"  - [eng] FLASH WHEN FIRED [ru] ВСПЫШКА ОТ ВЫСТРЕЛА
//fx_shotgun_shells      "1"  - [eng] SHELLS WHEN FIRED [ru] ГИЛЬЗЫ ПОСЛЕ ВЫСТРЕЛА
//fx_shotgun_vibrate     "1"  - [eng] SHOT VIBRATION [ru] ВИБРАЦИЯ ЭКРАНА ОТ ВЫСТРЕЛА
//fx_shotgun_impact_size "2"  - [eng] SHOT/IMPACT SIZE [ru] РАЗМЕР СЛЕДА ОТ ВЫСТРЕЛА
//...
//...
